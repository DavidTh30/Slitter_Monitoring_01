...
begin
  ...
  if (i>0) and (ComboBox4.Caption='Speed Actual') then DB1XX_SourceRecord1.MemFile_DB:=320;
  if (i>0) and (ComboBox4.Caption='Torque Setpoint') then DB1XX_SourceRecord1.MemFile_DB:=312;
  if (i>0) and (ComboBox4.Caption='Torque Actual') then DB1XX_SourceRecord1.MemFile_DB:=322;

  i:=pos('R',ComboBox3.Caption);

  if (i>0) and (ComboBox4.Caption='Speed Setpoint') then DB1XX_SourceRecord1.MemAddress :=332;
  if (i>0) and (ComboBox4.Caption='Speed Actual') then DB1XX_SourceRecord1.MemFile_DB:=342;
  if (i>0) and (ComboBox4.Caption='Torque Setpoint') then DB1XX_SourceRecord1.MemFile_DB:=334;
  if (i>0) and (ComboBox4.Caption='Torque Actual') then DB1XX_SourceRecord1.MemFile_DB:=344;
end;
...
begin
  ...
  if (i>0) and (ComboBox6.Caption='Speed Actual') then DB1XX_SourceRecord2.MemFile_DB:=320;
  if (i>0) and (ComboBox6.Caption='Torque Setpoint') then DB1XX_SourceRecord2.MemFile_DB:=312;
  if (i>0) and (ComboBox6.Caption='Torque Actual') then DB1XX_SourceRecord2.MemFile_DB:=322;

  i:=pos('R',ComboBox5.Caption);

  if (i>0) and (ComboBox6.Caption='Speed Setpoint') then DB1XX_SourceRecord2.MemAddress :=332;
  if (i>0) and (ComboBox6.Caption='Speed Actual') then DB1XX_SourceRecord2.MemFile_DB:=342;
  if (i>0) and (ComboBox6.Caption='Torque Setpoint') then DB1XX_SourceRecord2.MemFile_DB:=334;
  if (i>0) and (ComboBox6.Caption='Torque Actual') then DB1XX_SourceRecord2.MemFile_DB:=344;
...
begin
  ...
  if (i>0) and (ComboBox8.Caption='Speed Actual') then DB1XX_SourceRecord3.MemFile_DB:=320;
  if (i>0) and (ComboBox8.Caption='Torque Setpoint') then DB1XX_SourceRecord3.MemFile_DB:=312;
  if (i>0) and (ComboBox8.Caption='Torque Actual') then DB1XX_SourceRecord3.MemFile_DB:=322;

  i:=pos('R',ComboBox7.Caption);

  if (i>0) and (ComboBox8.Caption='Speed Setpoint') then DB1XX_SourceRecord3.MemAddress :=332;
  if (i>0) and (ComboBox8.Caption='Speed Actual') then DB1XX_SourceRecord3.MemFile_DB:=342;
  if (i>0) and (ComboBox8.Caption='Torque Setpoint') then DB1XX_SourceRecord3.MemFile_DB:=334;
  if (i>0) and (ComboBox8.Caption='Torque Actual') then DB1XX_SourceRecord3.MemFile_DB:=344;
end;
